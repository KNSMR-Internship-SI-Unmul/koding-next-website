<footer class="bg-white text-black border-t border-gray-300">
    <div class="container mx-auto px-6 py-10">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start gap-8">
            <div class="max-w-md">
                <img src="/images/logo-kn.png" alt="Koding Next" class="h-10 mb-4">
            ...
            <div class="text-sm space-y-3">
                ...
                <a href="https://instagram.com/kodingnext_samarinda" target="_blank"
        ...
        <div class="text-center text-xs text-gray-500 mt-8">
            © {{ date('Y') }} - KODING NEXT SAMARINDA. ALL RIGHTS RESERVED
        </div>
    </div>
</footer>
